...
if [ -f /home/metodiew/.config/flameshot/flameshot.ini ]; then
	cp /home/metodiew/.config/flameshot/flameshot.ini "$BACKUPFOLDERROOT/Config Files/";
else
...
if [ -f /home/metodiew/.config/Cursor/User/settings.json ]; then
	cp /home/metodiew/.config/Cursor/User/settings.json "$BACKUPFOLDERROOT/Config Files/Cursor/";
else
	echo "Cursor settings.json not found, skipping.";
fi

if [ -f /home/metodiew/.config/Cursor/User/keybindings.json ]; then
	cp /home/metodiew/.config/Cursor/User/keybindings.json "$BACKUPFOLDERROOT/Config Files/Cursor/";
else
...
if [ -f /home/metodiew/.config/filezilla/sitemanager.xml ]; then
	cp -r /home/metodiew/.config/filezilla/sitemanager.xml "$BACKUPFOLDERROOT/FileZilla/";
elif [ -f /home/metodiew/.local/share/filezilla/sitemanager.xml ]; then
	cp -r /home/metodiew/.local/share/filezilla/sitemanager.xml "$BACKUPFOLDERROOT/FileZilla/";
else
